...
Aucuparia is being developed on ruby 2.1.6, and rails 4.2.0. It requires Imagemagick, Rake, and Bundler. Git is strongly suggested. Once those dependencies are met, it can be set up fairly easily:
